        ...
        if name.startswith("BOOL_IND_"):
            ...
            if isinstance(val, (int, float)) and val >= 0:
                if max_idx is not None and int(val) > max_idx:
                    continue
                base = name.replace("BOOL_IND_", "")
                override = IN_INDEX_OVERRIDES.get(base, base)
                if override is None:
                    continue  # saltato
...
IN_INDEX_OVERRIDES = {
    "INENABLED": "MACSTARTEDIN",
    "LEFTSEL": "RCLEFTSEL",
    "RIGHTSEL": "RCRIGHTSEL",
    "STARTSENSOR": "STARTSENSORIN",
    "MANMODESEL": "MANSEL",
    "TESTMODESEL": "TESTSEL",
    "CONSOLE1MODESEL": "CONSOLE1SEL",
    "SINGMOVSEL": "SINGLEMOVSEL",
    "DISABLEBP1": "BPDISABLE1",
    "DISABLEBP2": "BPDISABLE2",
    "DISABLEBP3": "BPDISABLE3",
    "DISABLEBP4": "BPDISABLE4",
    "DISABLEBP5": "BPDISABLE5",
    "DISABLEBP6": "BPDISABLE6",
    "DISABLEBP7": "BPDISABLE7",
    "DISABLEBP8": "BPDISABLE8",
    "DISABLEBP9": "BPDISABLE9",
    "DISABLEBP10": "BPDISABLE10",
    "DISABLEBP11": "BPDISABLE11",
    "DISABLEBP12": "BPDISABLE12",
    "GREASEPUMPON": "PUMPONCALC",
    "GREASEALARM": "GREASEALARMCALC",
    "GREASEPUMPALARM": "PUMPALARMCALC",
    "LEFTMEM": "RCLEFTMEM",
    "RIGHTMEM": "RCRIGHTMEM",
    "MICROMODESEL": "MICROSEL",
    "TILTBAL": "ROLLTILTBALANCED",
}

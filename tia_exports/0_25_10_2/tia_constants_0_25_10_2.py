...
class DATA_CONFIG:
    def __init__(self):
        ...
        self.ConfigReqTime = None  # Time // NON USATO
        self._defaults['ConfigReqTime'] = None
        self.ConfigReqTimeout = -1  # ULInt // NON USATO
        self._defaults['ConfigReqTimeout'] = -1
        self.ConfigAckTime = None  # Time // NON USATO
        self._defaults['ConfigAckTime'] = None
        self.ConfigAckTimeout = -1  # ULInt // NON USATO
        ...
        self.SaveSettingsReq = False  # Bool // Richiesta di scrittura settings.yaml calcolata dal PLC (un ciclo)
        self._defaults['SaveSettingsReq'] = False
...
STATOINT_IND_FREE2 = 1  # era STATOINT_IND_CURRDIAGIND, STATOINT_IND_EMGCYBITS
...
STATOREAL_IND_FREE5 = 5  # era STATOREAL_IND_PINCHPRESSPROG
...
SETTING_BOOL_FREE_1 = 1  # era SETTING_BOOL_ORIENT
...
HMIASSE_CONFIG = 0
HMIASSE_CONFIGMAN = 1
HMIASSE_CONFIGONOFFMAN = 2
HMIASSE_CONFIGTOPMAN = 3
HMIASSE_CONFIGBOTTOMMAN = 4
HMIASSE_CONFIGUPMAN = 5
HMIASSE_CONFIGDOWNMAN = 6
HMIASSE_CONFIGDELTAMAN = 7
HMIASSE_CONFIGAUTO = 8
HMIASSE_CONFIGONOFFAUTO = 9
HMIASSE_CONFIGTOPAUTO = 10
HMIASSE_CONFIGBOTTOMAUTO = 11
HMIASSE_CONFIGUPAUTO = 12
HMIASSE_CONFIGDOWNAUTO = 13
HMIASSE_CONFIGDELTAAUTO = 14
HMIASSE_CONFIGSMAX = 15
HMIASSE_CONFIGSMIN = 16
HMIASSE_CONFIGSHH = 17
HMIASSE_CONFIGSH = 18
HMIASSE_CONFIGSL = 19
HMIASSE_CONFIGSLL = 20
HMIASSE_CONFIGAXIS = 21
HMIASSE_CONFIGINTERP = 22
HMIASSE_CONFIGTEACH = 23
HMIASSE_INTMASTER = 0
HMIASSE_INTFEEDBACK = 1
HMIASSE_INTOUTPUT1 = 2
HMIASSE_INTTIPO = 3
HMIASSE_INTGRAFIND = 4
HMIASSE_INTSUPLSIND = 5
HMIASSE_INTINFLSIND = 6
HMIASSE_INTDEFSPEED = 7
HMIASSE_INTMOVEMODE = 8
HMIASSE_INTINTERPGROUP = 9
HMIASSE_REALBWVMAX = 0
HMIASSE_REALFWVMAX = 1
HMIASSE_REALTILTMAX = 2
...
IO_INT_MEMTYPE = 5
IO_INT_FREE7 = 7  # Non serve
IO_INT_FREE8 = 8  # Non serve
IO_DINT_DDEFVAL = 0
...
MAX_PARAMSTRING = 3
MAX_PARAMBOOL = 59  # era 54 nella v.022, 49 nella v.0.18
...
DIM_ASSEHMIINT = 13
DIM_ASSEHMIREAL = 4
MAX_ASSEHMIBOOL = 47  # MAX_ASSE
MAX_ASSEHMIINT = 633  # (MAX_ASSE + 1) * DIM_ASSEHMIINT - 1
MAX_ASSEHMIREAL = 191  # (MAX_ASSE + 1) * DIM_ASSEHMIREAL - 1
MAX_STATOOUTINT = 7
MAX_STATOOUTDINT = 1
MAX_STATOOUTREAL = 15
...
REAL_FREE_52 = 52  # era REAL_ALIGN_DELTAPOSOK - non usato
...
BOOL_IND_RCLUP = 97  # era BOOL_IND_EMGCYPBFENCE2
BOOL_IND_RCLDOWN = 98  # era BOOL_IND_EMGCYPHOTOCELL2
BOOL_IND_RCRUP = 99  # era BOOL_IND_EMGCYPHOTOCELL3
BOOL_IND_RCRDOWN = 100  # era BOOL_IND_EMGCYPHOTOCELL4
BOOL_IND_RCBUP = 101  # era BOOL_IND_EMGCYDOOR
BOOL_IND_RCBDOWN = 102  # era BOOL_IND_EMGCYDOOR2
BOOL_IND_RCTLEFT = 103  # era BOOL_IND_EMGCYLASER
BOOL_IND_RCTRIGHT = 104  # era BOOL_IND_EMGCYLIGHT
...
CMDBOOL_FREE_25 = 25  # era CMDBOOL_TABSTAT2_ACK
COD_REPEATEND = 3031
COD_APPLY = 3032
MAX_REPEAT = 2
...
MAX_IFMVBB = 11
PINCH_NONE = 0
ASSE_INT_SLOWIND = 70  # DISABLED HDMC
...
FUN_AXIS_PREMFC = 62  # Prebend Machine Front Clamp
FUN_AXIS_PREMRC = 63  # Prebend Machine Rear Clamp
FUN_AXIS_BENDMFC = 64  # Bend Machine Front Clamp
FUN_AXIS_BENDRRC = 65  # BendMachine Rear Clamp
FUN_AXIS_FREE_66 = 66
FUN_AXIS_FREE_67 = 67
FUN_AXIS_FREE_68 = 68
FUN_AXIS_FREE_69 = 69
...
MAX_SER_STEPS = 90
SYNDIAG_MAXBOOL = 31
SYNDIAG_MAXDINT = 103  # Dint per Int e DInt
SYNDIAG_MAXREAL = 19
...
ACKBOOL_FREE_3 = 3  # era ACKBOOL_SETTINGS
MAX_ACKBOOL = 5
...
SER_PARAMGREASE = 20
SER_PARAMPINCH = 21
SER_PARAMARCHIMETER = 22
BOOL_IND_UNBALLEFT = 120  # era BOOL_IND_EMGCYPHOTOCELLREQ
BOOL_IND_UNBALRIGHT = 121  # era BOOL_IND_EMGCYPHOTOCELLREQ2
BOOL_IND_LATROLLLOWER = 122  # era BOOL_IND_EMGCYPHOTOCELLREQ3
BOOL_IND_ANYROLLLOWER = 123  # era BOOL_IND_EMGCYPHOTOCELLREQ4
...
BOOL_IND_FREE_128 = 128  # era BOOL_IND_EMGCYHOLDTORUNERR
BOOL_IND_FREE_129 = 129  # era BOOL_IND_EMGCYHWERR
BOOL_IND_FREE_130 = 130  # era BOOL_IND_EMGCYLOCKHWMSG
BOOL_IND_FREE_131 = 131
BOOL_IND_FREE_132 = 132

...
__version__ = '0.25.50.3'

# --- DB DATA_CONFIG.db ---
class DATA_CONFIG:
    def __init__(self):
        self._defaults = {}
        self.PLCVersion = " " * (DIM_STRINGNAME)  # String["DIM_STRINGNAME"]
        ...
        self.ConfigReqTime = None  # Time
        self._defaults['ConfigReqTime'] = None
        self.ConfigReqTimeout = -1  # ULInt
        self._defaults['ConfigReqTimeout'] = -1
        self.ConfigAckTime = None  # Time
        self._defaults['ConfigAckTime'] = None
        self.ConfigAckTimeout = -1  # ULInt
        self._defaults['ConfigAckTimeout'] = -1
        ...
        self.ParamString = [" " * DIM_STRINGNAME] * (MAX_PARAMSTRING + 1)  # Array[0.."MAX_PARAMSTRING"] of String["DIM_STRINGNAME"]
        self._defaults['ParamString'] = [" " * DIM_STRINGNAME] * (MAX_PARAMSTRING + 1)
        ...
        self.Alarm_Name = [" " * DIM_STRINGNAME] * (MAX_ALARM + 1)  # Array[0.."MAX_ALARM"] of String["DIM_STRINGNAME"]
        self._defaults['Alarm_Name'] = [" " * DIM_STRINGNAME] * (MAX_ALARM + 1)
        self.Alarm_Param = [Type_AlarmParam() for _ in range(MAX_ALARM + 1)]  # Array[0.."MAX_ALARM"] of "Type_AlarmParam"
        self._defaults['Alarm_Param'] = self.Alarm_Param
        self.Stop_Num = -1  # Int
        self._defaults['Stop_Num'] = -1
        self.Stop_Name = [" " * DIM_STRINGNAME] * (MAX_STOP + 1)  # Array[0.."MAX_STOP"] of String["DIM_STRINGNAME"]
        self._defaults['Stop_Name'] = [" " * DIM_STRINGNAME] * (MAX_STOP + 1)
        self.Stop_Ind = [-1] * (MAX_STOP + 1)  # Array[0.."MAX_STOP"] of Int
        self._defaults['Stop_Ind'] = [-1] * (MAX_STOP + 1)
        self.Maint_Name = [" " * DIM_STRINGNAME] * (MAX_MAINT + 1)  # Array[0.."MAX_MAINT"] of String["DIM_STRINGNAME"]
        self._defaults['Maint_Name'] = [" " * DIM_STRINGNAME] * (MAX_MAINT + 1)
        self.Maint_Param = [Type_MaintParam() for _ in range(MAX_MAINT + 1)]  # Array[0.."MAX_MAINT"] of "Type_MaintParam"
        self._defaults['Maint_Param'] = self.Maint_Param
        self.Toolset_Name = [" " * DIM_STRINGNAME] * (MAX_TOOLSET + 1)  # Array[0.."MAX_TOOLSET"] of String["DIM_STRINGNAME"]
        self._defaults['Toolset_Name'] = [" " * DIM_STRINGNAME] * (MAX_TOOLSET + 1)
        self.Toolset_Param = [Type_ToolsetParam() for _ in range(MAX_TOOLSET + 1)]  # Array[0.."MAX_TOOLSET"] of "Type_ToolsetParam"
        self._defaults['Toolset_Param'] = self.Toolset_Param
        ...
        self.UM_Name = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)  # Array[0.."MAX_UM"] of String["DIM_STRINGUMNAME"]
        self._defaults['UM_Name'] = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)
        self.UM_Name_Met = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)  # Array[0.."MAX_UM"] of String["DIM_STRINGUMNAME"]
        self._defaults['UM_Name_Met'] = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)
        self.UM_Name_Imp = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)  # Array[0.."MAX_UM"] of String["DIM_STRINGUMNAME"]
        self._defaults['UM_Name_Imp'] = [" " * DIM_STRINGUMNAME] * (MAX_UM + 1)
        self.Teach = Type_Teach()  # "Type_Teach"
        self._defaults['Teach'] = self.Teach
        self.Seq = Type_Seq()  # "Type_Seq"
        self._defaults['Seq'] = self.Seq
        self.HMIAdd0 = -1  # Int
        self._defaults['HMIAdd0'] = -1

        self.PLCVersion = '0'
        self.ConfigReqTime = 'T#0MS'
        self.ConfigReqTimeout = 4000
        self.ConfigAckTimeout = 4000
        self.ConfigSaveReqTimeout = 1500
        self.TabstatReqTimeout = 800
        self.ProgReqHMITimeout = 1500
        self.DebugInd = -1
        self.DebugInd2 = -1
        self.ParamRealFC[0] = 1.0
        self.ParamRealFC[1] = 1.0
        self.ParamRealFC[2] = 1.0
        self.ParamRealFC[3] = 1.0
        self.ParamRealFC[4] = 1.0
        self.ParamRealFC[5] = 1.0
        self.ParamRealFC[6] = 1.0
        self.ParamRealFC[7] = 1.0
        self.ParamRealFC[8] = 1.0
        self.ParamRealFC[9] = 1.0
        self.ParamRealFC[10] = 1.0
        self.ParamRealFC[11] = 1.0
        self.ParamRealFC[12] = 1.0
        self.ParamRealFC[13] = 1.0
        self.ParamRealFC[14] = 1.0
        self.ParamRealFC[15] = 1.0
        self.ParamRealFC[16] = 1.0
        self.ParamRealFC[17] = 1.0
        self.ParamRealFC[18] = 1.0
        self.ParamRealFC[19] = 1.0
        self.ParamRealFC[20] = 1.0
        self.ParamRealFC[21] = 1.0
        self.ParamRealFC[22] = 1.0
        self.ParamRealFC[23] = 1.0
        self.ParamRealFC[24] = 1.0
        self.ParamRealFC[25] = 1.0
        self.ParamRealFC[26] = 1.0
        self.ParamRealFC[27] = 1.0
        self.ParamRealFC[28] = 1.0
        self.ParamRealFC[29] = 1.0
        self.ParamRealFC[30] = 1.0
        self.ParamRealFC[31] = 1.0
        self.ParamRealFC[32] = 1.0
        self.ParamRealFC[33] = 1.0
        self.ParamRealFC[34] = 1.0
        self.ParamRealFC[35] = 1.0
        self.ParamRealFC[36] = 1.0
        self.ParamRealFC[37] = 1.0
        self.ParamRealFC[38] = 1.0
        self.ParamRealFC[39] = 1.0
        self.ParamRealFC[40] = 1.0
        self.ParamRealFC[41] = 1.0
        self.ParamRealFC[42] = 1.0
        self.ParamRealFC[43] = 1.0
        self.ParamRealFC[44] = 1.0
        self.ParamRealFC[45] = 1.0
        self.ParamRealFC[46] = 1.0
        self.ParamRealFC[47] = 1.0
        self.ParamRealFC[48] = 1.0
        self.ParamRealFC[49] = 1.0
        self.ParamRealFC[50] = 1.0
        self.ParamRealFC[51] = 1.0
        self.ParamRealFC[52] = 1.0
        self.ParamRealFC[53] = 1.0
        self.ParamRealFC[54] = 1.0
        self.ParamRealFC[55] = 1.0
        self.ParamRealFC[56] = 1.0
        self.ParamRealFC[57] = 1.0
        self.ParamRealFC[58] = 1.0
        self.ParamRealFC[59] = 1.0
        self.ParamRealFC[60] = 1.0
        self.ParamRealFC[61] = 1.0
        self.ParamRealFC[62] = 1.0
        self.ParamRealFC[63] = 1.0
        self.ParamRealFC[64] = 1.0
        self.ParamRealFC[65] = 1.0
        self.ParamRealFC[66] = 1.0
        self.ParamRealFC[67] = 1.0
        self.ParamRealFC[68] = 1.0
        self.ParamRealFC[69] = 1.0
        self.ParamRealFC[70] = 1.0
        self.ParamRealFC[71] = 1.0
        self.ParamRealFC[72] = 1.0
        self.ParamRealFC[73] = 1.0
        self.ParamRealFC[74] = 1.0
        self.ParamRealFC[75] = 1.0
        self.ParamRealFC[76] = 1.0
        self.ParamRealFC[77] = 1.0
        self.ParamRealFC[78] = 1.0
        self.ParamRealFC[79] = 1.0
        self.Axis_Param[0].realval[51] = 0.0
        self.UM_FC_Met[0] = 1.0
        self.UM_FC_Met[1] = 1.0
        self.UM_FC_Met[2] = 1.0
        self.UM_FC_Met[3] = 1.0
        self.UM_FC_Met[4] = 1.0
        self.UM_FC_Met[5] = 1.0
        self.UM_FC_Met[6] = 1.0
        self.UM_FC_Met[7] = 1.0
        self.UM_FC_Met[8] = 1.0
        self.UM_FC_Met[9] = 1.0
        self.UM_FC_Met[10] = 1.0
        self.UM_FC_Met[11] = 1.0
        self.UM_FC_Met[12] = 1.0
        self.UM_FC_Imp[0] = 0.0393701
        self.UM_FC_Imp[1] = 14.50377
        self.UM_FC_Imp[2] = 1.8
        self.UM_FC_Imp[3] = 1.0
        self.UM_FC_Imp[4] = 145.0377
        self.UM_FC_Imp[5] = 1.0
        self.UM_FC_Imp[6] = 0.0393701
        self.UM_FC_Imp[7] = 14.50377
        self.UM_FC_Imp[8] = 0.001550005
        self.UM_FC_Imp[9] = 0.00109361
        self.UM_FC_Imp[10] = 145.0377
        self.UM_FC_Imp[11] = 1.0
        self.UM_FC_Imp[12] = 1.0
        self.UM_Offset_Imp[2] = 32.0
        self.UM_NDec[9] = 0
        self.UM_NDec_Met[0] = 1
        self.UM_NDec_Met[2] = 1
        self.UM_NDec_Met[6] = 1
        self.UM_NDec_Met[7] = 1
        self.UM_NDec_Met[9] = 1
        self.UM_NDec_Imp[0] = 3
        self.UM_NDec_Imp[3] = 1
        self.UM_NDec_Imp[4] = 1
        self.UM_NDec_Imp[5] = 0
        self.UM_NDec_Imp[6] = 2
        self.UM_NDec_Imp[7] = 0
        self.UM_NDec_Imp[8] = 2
        self.UM_NDec_Imp[9] = 1
        self.UM_Name[0] = ''
        self.UM_Name[1] = ''
        self.UM_Name[2] = ''
        self.UM_Name[3] = ''
        ...
        self.UM_Name[8] = ''
        self.UM_Name[9] = ''
        self.UM_Name_Met[0] = 'mm'
        self.UM_Name_Met[1] = 'bar'
        self.UM_Name_Met[2] = 'C'
        self.UM_Name_Met[3] = '%'
        self.UM_Name_Met[4] = 'MPa'
        self.UM_Name_Met[5] = '%'
        self.UM_Name_Met[6] = 'mm/sec'
        self.UM_Name_Met[7] = 'mm/sec2'
        self.UM_Name_Met[8] = 'mm2'
        self.UM_Name_Met[9] = 'm'
        self.UM_Name_Met[10] = 'GPa'
        self.UM_Name_Met[11] = 'deg'
        self.UM_Name_Imp[0] = 'in'
        self.UM_Name_Imp[1] = 'psi'
        self.UM_Name_Imp[2] = 'F'
        self.UM_Name_Imp[3] = '%'
        self.UM_Name_Imp[4] = 'psi'
        self.UM_Name_Imp[5] = '%'
        self.UM_Name_Imp[6] = 'in/sec'
        self.UM_Name_Imp[7] = 'in/sec2'
        self.UM_Name_Imp[8] = 'in2'
        self.UM_Name_Imp[9] = 'yd'
        self.UM_Name_Imp[10] = 'ksi'
        self.UM_Name_Imp[11] = 'deg'
        self.Seq.SeqNum = 3
        self.Seq.SeqFirst = 0
        self.Seq.SeqLast = 2
        self.Seq.SeqId[0] = 1
        ...
        self.Seq.SeqTyp[1] = 1
        self.Seq.SeqTyp[2] = 1
        self.Seq.SeqFirstStat[0] = 0
        self.Seq.SeqFirstStat[1] = 2
        self.Seq.SeqFirstStat[2] = 3
        self.Seq.SeqFirstStat[3] = -1
        self.Seq.SeqFirstStat[4] = -1
        self.Seq.SeqFirstStat[5] = -1
        self.Seq.SeqLastStat[0] = 1
        self.Seq.SeqLastStat[1] = 2
        self.Seq.SeqLastStat[2] = 3
        self.Seq.SeqLastStat[3] = -1
        self.Seq.SeqLastStat[4] = -1
        self.Seq.SeqLastStat[5] = -1
        self.Seq.SeqNext[0] = 1
        self.Seq.SeqNext[1] = 2
        self.Seq.SeqNext[2] = -1
        self.Seq.SeqNext[3] = -1
        self.Seq.SeqNext[4] = -1
        self.Seq.SeqNext[5] = -1
        self.Seq.SeqNumStat[0] = 2
        self.Seq.SeqNumStat[1] = 1
        self.Seq.SeqNumStat[2] = 1
        self.Seq.SeqNumStat[3] = 0
        self.Seq.SeqNumStat[4] = 0
        self.Seq.SeqNumStat[5] = 0
        self.Seq.StatNum = 4
        self.Seq.Stat[0].seqid = 1
        self.Seq.Stat[0].pos = 0
        self.Seq.Stat[0].cod = 0
        self.Seq.Stat[0].next = 1
        self.Seq.Stat[0].prim = 1
        self.Seq.Stat[1].seqid = 1
        self.Seq.Stat[1].pos = 1
        self.Seq.Stat[1].cod = 3020
        self.Seq.Stat[1].prim = 1
        self.Seq.Stat[2].seqid = 2
        self.Seq.Stat[2].pos = 0
        self.Seq.Stat[2].cod = 3215
        self.Seq.Stat[2].firstparam = 0
        self.Seq.Stat[2].lastparam = 0
        self.Seq.Stat[2].next = -1
        self.Seq.Stat[2].prim = 1
        self.Seq.Stat[3].seqid = 3
        self.Seq.Stat[3].pos = 0
        self.Seq.Stat[3].cod = 3210
        self.Seq.Stat[3].firstparam = 1
        self.Seq.Stat[3].lastparam = 1
        self.Seq.Stat[3].next = -1
        self.Seq.Stat[3].prim = 1
        self.Seq.StatParamNum = 2
        self.Seq.StatParam[0].seqid = 2
        self.Seq.StatParam[0].statpos = 0
        self.Seq.StatParam[0].pos = 0
        self.Seq.StatParam[0].objtype = 5
        self.Seq.StatParam[1].seqid = 3
        self.Seq.StatParam[1].statpos = 0
        self.Seq.StatParam[1].pos = 0
        self.Seq.StatParam[1].objtype = 1
        self.Seq.StatParam[1].addr = 31
        self.Seq.SeqStartCurrId = -1
        self.Seq.SeqStartPrevId = -1
        self.Seq.StackLevel = -1
        self.Seq.StackLevelAuto = -1
        self.Seq.CurrProgSeq = -1
        self.Seq.PrevProgSeq = -1
        self.HMIAdd0 = 30000
...
class Type_Seq:
    ...
    def __init__(self):
        ...
        self.Stat = [Type_Stat] * (MAX_STAT + 1)  # Array[0.."MAX_STAT"] of "Type_Stat"
        self._defaults['Stat'] = [Type_Stat] * (MAX_STAT + 1)
        self.StatParamNum = -1  # Int
        self._defaults['StatParamNum'] = -1
        self.StatParam = [Type_StatParam] * (MAX_STATPARAM + 1)  # Array[0.."MAX_STATPARAM"] of "Type_StatParam"
        self._defaults['StatParam'] = [Type_StatParam] * (MAX_STATPARAM + 1)
...
class Type_ToolsetParam:
    ...
    def __init__(self):
        ...
        self.output = [None] * (MAX_TOOLSETOUTPUT + 1)  # Array[0.."MAX_TOOLSETOUTPUT"] of "Type_ToolsetOutputParam" := [([2(-1)], [()]), ([2(-1)], [()]), ([2(-1)], [()]), ([2(-1)], [()])]
        self._defaults['output'] = [None] * (MAX_TOOLSETOUTPUT + 1)
...
class Type_IOParam:
    ...
    def __init__(self):
        ...
        self.exprintval = [-1] * (MAX_EXPRINT + 1)  # Array[0.."MAX_EXPRINT"] of Int := [25(-1)]
...
STATOREAL_IND_FREE5 = 5
STATOREAL_IND_PINCHPRESSAUTO = 6
STATOREAL_IND_PINCHPRESS2 = 7
STATOREAL_IND_PINCHPRESSMAN2 = 8
STATOREAL_IND_FREE9 = 9
STATOREAL_IND_PINCHPRESSAUTO2 = 10
STATOREAL_IND_FREE11 = 11
STATOREAL_IND_FREE12 = 12
STATOREAL_IND_FREE13 = 13
STATOREAL_IND_CURRRELROT = 14
...
BOOL_IND_EMGCYPB = 5
BOOL_IND_CONSOLE2MODESEL = 6  # ea DECLOSED
BOOL_IND_INENABLED = 8  # Solo se deve essere copiato in OUT - Era DROLLDOWN
BOOL_IND_CHROLLMODESEL = 7  # era DEOPEN
BOOL_IND_STARTIN = 12
BOOL_IND_STOPIN = 13
...
BOOL_IND_LEFTSEL = 17
BOOL_IND_PINCHPRESS = 18  # era BOOL_IND_PHOTOCELLON
...
REAL_G = 26
REAL_S = 27
REAL_STARTSENSORDIST = 28
REAL_BFSUPADJ = 29
REAL_BFINFADJ = 30
REAL_K = 31
REAL_EXTDIST = 32
REAL_LREFFCYLAREA = 33
REAL_DEFPINCHPRESS = 34
REAL_PINCHPRESSDELTA = 35
REAL_PINCHPRESSTEST = 36
...
CMDREAL_MANOFFSETPINCHPRESS = 0
CMDBOOL_SLIDER_ACK = 5
...
SETTING_BOOL_LOADMODE = 0
SETTING_BOOL_FLAGGEO = 1
...
ASSE_BOOL_BP5 = 5
ASSE_BOOL_BP6 = 6
ASSE_BOOL_DISABLEDELTA = 30
ASSE_BOOL_ENABSH0 = 31
ASSE_BOOL_ENABSL0 = 32
ASSE_BOOL_FLAGCOUPMAX = 13
...
ASSE_INT_FEEDBACK = 1
ASSE_INT_INPUT = 2
ASSE_INT_INPUT2 = 3  # era ASSE_INT_DELTA
ASSE_INT_INPUT3 = 4  # era ASSE_INT_INPUT2
ASSE_INT_INPUT4 = 5  # era ASSE_INT_DELTA2
ASSE_INT_OUTPUT1 = 6
ASSE_INT_OUTPUT2 = 7
ASSE_REAL_SRTUP = 0
ASSE_REAL_SRTDOWN = 1
ASSE_REAL_COEFFUP = 2
ASSE_REAL_COEFFDOWN = 3
ASSE_INT_OUTPUT3 = 8
ASSE_INT_OUTPUT4 = 9
ASSE_INT_LABELTYPE = 10
...
ASSE_REAL_P2UP = 6
ASSE_REAL_P2DOWN = 7
ASSE_INT_TIMEOUT1 = 23
ASSE_INT_TIMEOUT2 = 24
ASSE_INT_BOOSTVAL = 25
ASSE_INT_TIPOMISURA = 26
ASSE_REAL_SYSPRESSUP1 = 8
ASSE_REAL_SYSPRESSDOWN1 = 9
ASSE_REAL_SYSPRESSUP2 = 10
ASSE_REAL_SYSPRESSDOWN2 = 11
ASSE_REAL_SYSPRESSUP3 = 12
ASSE_REAL_SYSPRESSDOWN3 = 13
ASSE_REAL_BWVMAX = 14
ASSE_REAL_DSMAXDOWN = 15
ASSE_REAL_DSMAXUP = 16
ASSE_REAL_FWVMAX = 17
ASSE_REAL_SMAX = 18
ASSE_REAL_SMIN = 19
ASSE_REAL_SSUP = 20
ASSE_REAL_SINF = 21
ASSE_REAL_VMINSTARTED = 22
ASSE_REAL_SHH = 23
ASSE_REAL_SH = 24
ASSE_REAL_SL = 25
ASSE_REAL_SLL = 26
ASSE_REAL_TILTMAX = 27
...
BOOL_TELESERVICE = 32
BOOL_TUNING = 33
BOOL_ZEROTOP = 34  # Era BOOL_POSITION
BOOL_NL = 35
AXSTAT_SAF = 13
MISURA_E0 = 10
CMDBOOL_EYEBEND_REQ = 6
CMDDINT_EYEBEND_COMMAND = 0
STATOINT_IND_STATSTART = 5  # era STATOINT_IND_EYEBENDSTATUS
...
IO_BOOL_BDEFVAL = 0
IO_BOOL_PROG = 1
IO_BOOL_SIM = 2  # era IO_BOOL_FLAGTOTCNT
IO_BOOL_SIMVAL = 3  # era IO_BOOL_FLAGMEM
IO_INT_ADDRTYPE = 0
IO_INT_ADDR1 = 1
IO_INT_ADDR2 = 2
IO_INT_NBYTES = 3
IO_INT_MEMIND = 6  # era IO_INT_INDTOTCNT
IO_INT_MEMTYPE = 5
IO_INT_TIMEOUT = 7  # era IO_INT_MEMCLASS
IO_INT_ININD = 8  # era IO_INT_MEMPARAM
IO_DINT_DDEFVAL = 0
IO_REAL_RDEFVAL = 0
IO_REAL_DEADBAND = 1
...
DATALOGGER_TIMEOUT = 600000
MAX_DATALOGGER_BUFFER = 40
DATALOGGER_ALARM_CLASS = 1
DATALOGGER_MAINT_CLASS = 65
DATALOGGER_MAXRECCOUNTPER = 1000
ASSE_REAL_SLAVEVRESET = 31
ASSE_REAL_SLAVEVMIN = 32
ASSE_REAL_MASTERMULT = 28
ASSE_REAL_MASTERDELTAMIN = 29
ASSE_REAL_MASTERKSRS = 30
ASSE_REAL_SLAVEDELTATSTART = 33
ASSE_REAL_OUTKP = 34
ASSE_REAL_OUTDELTAT = 35
DATALOGGER_MAXRECCOUNTEVT = 1000
IO_REAL_COEFFMULT = 3
ASSE_REAL_SH0 = 36
ASSE_REAL_SL0 = 37
BOOL_IND_HOLDTORUN2 = 25
CMDBOOL_DEBUG_DISABLEFB = 7
...
MAX_DT = 99
ASSE_INT_PERACQ = 45
ASSE_INT_NUMTIMEOUT = 46
ASSE_INT_PERVELAVG = 47
REAL_LATSUPR0 = 37
REAL_LATSUPQ0 = 38
REAL_LATSUPR1 = 39
REAL_LATSUPQ1 = 40
...
COD_WIZARD_ELLIPSE = 4009
COD_WIZARD_REBEND1 = 4010
COD_WIZARD_OPEN = 4013
COD_WIZARD_REBEND2 = 4011
...
BOOL_IND_MAINTON = 59
BOOL_IND_RTFWDISABLED = 60  # No MACHINESTARTED perché serve per RSM
BOOL_IND_LEFTMEM = 61
BOOL_IND_RESETFLAG = 62  # era BOOL_IND_PHOTOCELLDISABLED
BOOL_IND_RIGHTMEM = 63
BOOL_IND_OUTENABLED = 64
BOOL_IND_STOPCMD = 65
BOOL_IND_QUALITYENAB = 66
BOOL_IND_TELESERVICEREQ = 67
BOOL_IND_MICROMODESEL = 68  # era BOOL_IND_MACHINEREADY
BOOL_IND_APPLY = 69
BOOL_IND_QUALITYEND = 70  # era BOOL_IND_PHOTOCELLCONFIG
BOOL_IND_QUALITYGOOD = 72
BOOL_IND_PARTEND = 73
BOOL_IND_AUTOCORR = 74  # era BOOL_IND_EYEBENDAUTOCORR
BOOL_IND_PARTBEGIN = 75
BOOL_IND_AUTOCORRSTARTED = 76  # era BOOL_IND_EYEBENDSTARTED
...
ASSE_REAL_DELTADIV = 42  # Delta totale distribuito su più assi
...
ASSE_BOOL_MANSPUP = 33  # abilita Jog Up
ASSE_BOOL_MANSPDOWN = 34  # abilita Jog Down
ASSE_BOOL_SHOWDELTATAB = 35  # se T -> delta in colonna Tab Stat
ASSE_BOOL_NOMACHINESTARTED = 36  # era 28 - non usato
ASSE_BOOL_BP7 = 7
ASSE_BOOL_BP8 = 8
ASSE_BOOL_BP9 = 9
ASSE_BOOL_BP10 = 10
...
COD_STOP = 5
COD_SETDI = 3055  # per DI CALC (o SW) - non per PNET
COD_RESETDI = 3056  # per DI CALC (o SW) - non per PNET
MACHTYPE_HAV12 = 3
MAX_GREASEV = 16
INT_GREASEIN1 = 32
INT_GREASEIN10 = 41
...
INT_GREASEIN8 = 39
INT_GREASEIN9 = 40
INT_ROLLIND = 26  # indice DI livello grasso
INT_GREASENUMFB = 30  # default numero feedback richiesti per valvola
INT_GREASENUMV = 64  # numero valvole grasso presenti (MAX 16)
INT_GREASEOUT1 = 48
INT_GREASEOUT10 = 57
INT_GREASEOUT11 = 58
INT_GREASEOUT12 = 59
...
INT_GREASEOUT8 = 55
INT_GREASEOUT9 = 56
INT_GREASEPUMPON = 65  # DI Grease Pump Started
INT_GREASEPUMPSTART = 27  # indice DO Start
INT_GREASETIMEOUT1 = 28  # default periodo di un ciclo completo
INT_GREASETIMEOUT2 = 29  # default timeout per la ricezione dei feedback richiesti
INT_FREE_31 = 31  # indice TR pompa grasso
INT_BP7TIMEOUT = 20
INT_BP8TIMEOUT = 21
INT_BP9TIMEOUT = 22
INT_BP10TIMEOUT = 23
...
ASSE_INT_BWVSLOW = 64
ASSE_INT_FWVSLOW = 65
INT_CHECKTYPE = 3  # 0=MAN,1=ARCM,2=EB_KEYENCE,3=EB_ORBBEC
CHECK_MANUAL = 0
CHECK_ARCHIMETER = 1
CHECK_EBKEYENCE = 2
CHECK_EBORBBEC = 3
...
ASSE_INT_BWVSLOW2 = 70
ASSE_INT_FWVSLOW2 = 71
INT_RESETTYPE = 72
...
COD_WIZARD_WT = 4015
OUTPUT_ADV = 5  # 20057
OUTPUT_PSLCAN = 6  # 20057
OUTPUT_SELFL = 7  # 20040 (era 4)
OUTPUT_SEL2PV = 8  # 6266 (2 PV per rotazione)
ALIGN_INITOK = 11
ALIGN_SASDOWN = 12
ALIGN_SASUP = 13
IO_TYPE_NONE = -1
...
REAL_EYEBEND_DZ = 55
REAL_EYEBEND_STEP = 56
REAL_EYEBEND_XMAX = 57
REAL_EYEBEND_ZMIN = 58
REAL_EYEBEND_ZMAX = 59
REAL_EYEBEND_DELTA = 60
REAL_ARCHIMETER_L1 = 61
REAL_ARCHIMETER_L2 = 62
...
FUN_AXIS_ALIGNSASA = 38
FUN_AXIS_ALIGNSASB = 39
FUN_AXIS_ALIGNCENTA0 = 40
FUN_AXIS_ALIGNCENTB0 = 41
FUN_AXIS_ALIGNCENTA1 = 42
FUN_AXIS_ALIGNCENTB1 = 43
FUN_AXIS_ALIGNCENTA2 = 44
FUN_AXIS_ALIGNCENTB2 = 45
FUN_AXIS_ALIGNCENTA3 = 46
FUN_AXIS_ALIGNCENTB3 = 47
FUN_AXIS_ALIGNCENTA4 = 48
FUN_AXIS_ALIGNCENTB4 = 49
FUN_AXIS_ALIGNROLLTABROT = 50
FUN_AXIS_ALIGNROLLTABTILT = 51
FUN_AXIS_ALIGNSASUPDOWN = 52
MOTOR_BOOL_LS = 0
MOTOR_BOOL_TR = 1
MOTOR_BOOL_CMD = 2
MOTOR_BOOL_STAT = 3
...
CMDBOOL_APPLYROT_END = 19
CMDREAL_AUTOPROGLENGTH = 1
CMDBOOL_REPEATEND_END = 20
CMDBOOL_APPLYRESET_END = 21
CMDBOOL_FREE_22 = 22
CMDBOOL_FREE_23 = 23
...
HDR_CALC = 11
MAX_SETTINGSREAL = 17
SETTING_REAL_DEFTHICKNESS = 0
SETTING_REAL_DEFWIDTH = 1
SETTING_REAL_DEFFSE = 2
SETTING_REAL_DEFYP = 3
SETTING_REAL_DEFE0 = 4
SETTING_REAL_DEFPINCHCOEFF = 5
SETTING_REAL_DEFPINCHPRESSS = 6
SETTING_REAL_DEFADDITROT = 7
SETTING_REAL_DEFTSDELTAUP = 8
SETTING_REAL_DEFTSDELTADOWN = 9
SETTING_BOOL_DEFVSENAB = 11
SETTING_BOOL_DEFSSENAB = 12
SETTING_BOOL_DEFHSENAB = 13
SETTING_BOOL_DEFSENSENAB = 14
SETTING_BOOL_DEFDEENAB = 15
SETTING_BOOL_DEFPPENAB = 16
SETTING_REAL_DEFPREBENDSPEED = 14
SETTING_REAL_DEFEBSTART = 10
SETTING_REAL_DEFEBEND = 11
SETTING_INT_DEFEBHOLEIND = 9
SETTING_BOOL_DEFBWPB = 17
SETTING_BOOL_DEFALIGNENAB = 18
SETTING_BOOL_DEFFPENAB = 19
SETTING_BOOL_DEFPROGTYPE = 20
SETTING_REAL_DEFSTARTPOS = 15
SETTING_BOOL_DEFQUALITYENAB = 21
...
SER_PARAMINT = 4
SER_PARAMREAL = 5
ASSE_INT_OPTPARAM1IND = 88
ASSE_INT_OPTPARAM2IND = 89
ASSE_INT_OPTPARAM3IND = 90
SAFETY_PROGIN = 3
...
HMIPAGE_CONFIG_IOCURR = 1060
HMIPAGE_CONFIG_IOLIST = 1061
HMIPAGE_CONFIG_IOSEL = 1062
HMIPAGE_CONFIG_IOEXPR = 1063
...
HMIPAGE_CONFIG_SMALL = 1200
HMIPAGE_CONFIG_SMPLATEROLLS = 1201
HMIPAGE_CONFIG_SMRTC1LEFT = 1202
HMIPAGE_CONFIG_SMRTC1RIGHT = 1203
HMIPAGE_CONFIG_SMRTC3LEFT = 1204
HMIPAGE_CONFIG_SMRTC3RIGHT = 1205
HMIPAGE_CONFIG_SMSECTIONROLLS = 1206
...
BOOL_IND_SYNCRELOADENAB = 141
BOOL_IND_SYNCRELOADALT = 142
...
CMDREAL_FREE_5 = 5
COD_CHECKDISTMEM = 3157
COD_CHECKDISTADJ = 3158
...
MAX_WARNING = 127
MAX_ALARM = 255
ALARM_COD_PB1_RESETREQ = 613
ALARM_COD_PB2_RESETREQ = 614
ALARM_COD_PB3_RESETREQ = 615
ALARM_COD_PB4_RESETREQ = 616
ALARM_COD_PB5_RESETREQ = 617
ALARM_COD_PB6_RESETREQ = 618
ALARM_COD_PB7_RESETREQ = 619
ALARM_COD_PB8_RESETREQ = 620
ALARM_COD_ES1_RESETREQ = 621
ALARM_COD_ES2_RESETREQ = 622
ALARM_COD_ES3_RESETREQ = 623
ALARM_COD_RP1_RESETREQ = 624
CMDBOOL_RELOAD_END = 33
CMDBOOL_USER_LOGGED = 34
MAX_CMDBOOL = 34
MAX_STATOBOOL = 159
BOOL_IND_RELOAD = 152
BOOL_IND_MACHINEMOVING = 153
BOOL_IND_FREE_154 = 154
BOOL_IND_FREE_155 = 155
BOOL_IND_FREE_156 = 156
BOOL_IND_FREE_157 = 157
BOOL_IND_FREE_158 = 158
BOOL_IND_FREE_159 = 159
SETTING_INT_LOGOFFTIMEOUT = 12

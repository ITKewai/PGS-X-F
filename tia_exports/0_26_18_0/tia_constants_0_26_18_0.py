...
class DATA_CONFIG:
    def __init__(self):
        ...
        self.CANNode_Param = [Type_CANNodeParam() for _ in range(MAX_CANNODE + 1)]  # Array[0.."MAX_CANNODE"] of "Type_CANNodeParam"
        self._defaults['CANNode_Param'] = self.CANNode_Param
        self.IFMExc_Param = [Type_IFMExcParam() for _ in range(MAX_IFMEXC + 1)]  # Array[0.."MAX_IFMEXC"] of "Type_IFMExcParam"
        self._defaults['IFMExc_Param'] = self.IFMExc_Param

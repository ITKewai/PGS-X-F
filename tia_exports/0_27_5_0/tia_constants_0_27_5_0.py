...
class DATA_CONFIG:
    def __init__(self):
        ...
        self.UM_FC[0] = 0.0393701
        self.UM_FC[1] = 14.50377
        self.UM_FC[2] = 1.8
        self.UM_FC[3] = 1.0
        self.UM_FC[4] = 145.0377
        self.UM_FC[5] = 1.0
        self.UM_FC[6] = 0.0393701
        self.UM_FC[7] = 14.50377
        self.UM_FC[8] = 0.001550005
        self.UM_FC[9] = 0.00109361
        self.UM_FC[10] = 145.0377
        self.UM_FC[11] = 1.0
        self.UM_FC[12] = 1.0
        self.UM_Offset[2] = 32.0
        self.UM_NDec[9] = 0
...
COD_PAUSE = 3050
COD_LOOP = 3021
COD_REPEAT = 3029  # TEMP: deve essere 3031
COD_SETDO = 3060
COD_SETAO = 3070
COD_SETPV = 3080
COD_WAITDI = 3090
...
MACHTYPE_RCMI = 8
MACHTYPE_4R = 9
SETTING_INT_FREE_0 = 0  # era SETTING_INT_UM
SETTING_INT_LANG = 1
...
CHECK_ARCHIMETER = 1
CHECK_EBKEYENCE = 2
CHECK_EBORBBEC = 4  # era 3 - non usato
COD_ALIGN = 3300
COD_ALIGNRESET = 3302
COD_WIZARD_WT = 4015
OUTPUT_ADV = 5
...
FUN_AXIS_SPIRDEV = 36  # Spiraling Device
FUN_AXIS_EB = 37
...
MAX_CMDREAL = 6  # era 5 prima di CALIB, era 3 prima di APPLYRESET, era 1 prima di 6498
...
CMDBOOL_AUTO_DISABLED = 22  # era CMDBOOL_PROG_ACK
CMDBOOL_CALIB = 23  # era CMDBOOL_SIM_ACK
...
BOOL_EB = 66  # era BOOL_SYNCLOADDI
BOOL_ARCHIMETER = 67  # era BOOL_SYNCUNLOADDI
BOOL_CALIB = 68  # era BOOL_SYNCSTART
BOOL_FREE_69 = 69  # era BOOL_SYNCSTARTDI
BOOL_FREE_70 = 70
BOOL_FREE_71 = 71
BOOL_SMARTCLIENT = 63
MAX_PARAMBOOL = 87  # 87 in v.0.27.1; da 63 a 71 in v.0.25.42.1; da 59 a 63 in v.0.25.28
...
MAX_PARAMINT = 87  # 87 nella 0.27.1; era 72 nella v.0.18
MAX_GREASEV = 16
INT_GREASEIN1 = 32
INT_GREASEIN10 = 41
INT_GREASEIN11 = 42
...
INT_EXTMEASDELAY = 70  # era INT_AVGDT_IND
...
INT_ROLLNUM = 79
REAL_FREE_0 = 0  # typ=-1 era REAL_B0COEFF
...
REAL_FREE_10 = 10  # typ = 0 era REAL_HADJUST
...
MAX_PARAMREAL = 87  # 87 nella v.0.27.1; era 62 nella v.0.18
REAL_LATSUPR0 = 37
REAL_LATSUPQ0 = 38
REAL_LATSUPR1 = 39
REAL_LATSUPQ1 = 40
...
BOOL_IND_AUTOMODEDISABLED = 104  # era BOOL_IND_RCTRIGHT, BOOL_IND_EMGCYLIGHT
...
BOOL_IND_HOLDTORUNLS = 129  # era BOOL_IND_SDOSTART, era BOOL_IND_EMGCYHWERR
BOOL_IND_LSCOMP = 130  # era BOOL_IND_SDOBUSY, era BOOL_IND_EMGCYLOCKHWMSG
...
MAX_STATOBOOL = 159  # era 151 in v.0.27.0, era 135 in v.0.25.42, era 127 in v.0.18
...
BOOL_IND_EJCDISABLED = 151  # da v.0.25.50.6.1.6849
...
COD_RADIUS_BC2 = 2023
COD_RADIUS_BIPOL2 = 2025
COD_RADIUS_BC3 = 2024
STATOINT_IND_REPEATIND = 8
COD_REPEATUNTILCHECK = 3030  # TEMP: deve essere 3031
COD_REPEATNTIMES = 3028  # TEMP: errore - si sovrappone a COD_APPLY
BOOL_IND_FREE_152 = 152
BOOL_IND_FREE_153 = 153
...
INT_FREE_86 = 86
INT_FREE_87 = 87
REAL_GX = 80  # Distanza X centro rullo laterale - centro albero guide
REAL_GY = 81  # Distanza Y centro rullo laterale - centro albero guide
REAL_GDMIN = 82  # Distanza inizio rullo contrasto - centro albero guida con contrasto (asse DX/EX) tutto chiuso
REAL_GRL = 83  # Lunghezza rullo contrasto
REAL_FREE_84 = 84
REAL_FREE_85 = 85
REAL_FREE_86 = 86
REAL_FREE_87 = 87
CMDREAL_CALIB_MAX = 6
CMDREAL_CALIB_START = 5
